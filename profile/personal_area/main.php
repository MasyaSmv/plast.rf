	...
	<body>
                    ...
                    <div class="wrDwse" style="top: 56px;">
                        ...
                        <div class="tC9kZd">
                            <nav class="tbyFuf">
                                <ul class="b3qkse">
                                    <li class="BBRNg">
                                        <a href="/profile/personal_area/main.php" class="VZLjze Wvetm EhlvJf KKjvXb">
                                            <div class="iKN8Oe">
        ...
        <div class="s7iwrf gMPiLc  Kdcijb" >
            ...
            <div class="ETkYLd">
                ...
                <div class="D8JwHb">
                    <!-- Шапка с фотографией пользователя и сменой аватара -->
                    <header class="xNklye">
                        <!-- Контейнер с картинкой -->
                        <div class="B1tEqd">
                            <!-- Аватар пользователя -->
                            <div class="cstRMd">
                                <!-- Кнопка смены картинки пользователя -->
                                <button type="button" class="hryX1e  rN3O0d" data-toggle="modal" data-target="#exampleModal" style="width: 96px; height: 96px;">
...
?>
                    ...
                    <section class="dQBdyc">
                        <!-- Первый контейнер с блоком -->
                        <div class="wJpH8c l5Ibu">
                            <div class="  XLK0Od">
                                <!-- Информационный блок -->
                                <div class="ahh38c">
                                                ...
                                                <div class="CljqTd">
                                                    ...
                                                    <div class="fxHFgc" style="width: 96px; height: 96px;">
                                                        ...
                                                        <figure class="HJOYV HJOYVi13">
                                                            <img class="YPzqGd" src="/img/lc.png">
                                                        </figure>
                                                    </div>
                                                </div>
                                            </header>
                        ...
                        <div class="wJpH8c l5Ibu">
                            <div class="  XLK0Od">
                                ...
                                <div class="ahh38c">
                                    ...
                                    <div class="ugt2L aK2X8b iDdZmf">
                                        <!-- Ссылка для перехода -->
                                        <a href="/profile/personal_area/downland_files/up_file.php" class="VZLjze Wvetm N5YmOc kJXJmd bvW4md I6g62c">
                                            <!-- Блок с текстами и картинкой -->
                                            <header class="mSUZQd">
                                                <!-- Блок с текстами -->
                                                <div class="jbRlDc">
                        ...
                        <div class="wJpH8c">
                            <div class="  XLK0Od XAdKte">
                                <!-- Контейнер с текстом дополнительной информации -->
                                <div class="ahh38c">
                                    <div class="ugt2L">
                                        <div>
                                            <!-- Блок с текстом дополнительной информации -->
                                            <div class="N5YmOc kJXJmd">
                                                <!-- Контейнер с блоком текста и картинки -->
                                                <header class="mSUZQd">
                                                    <!-- Контейнер текста -->
                                                    <div class="jbRlDc">
                                                        <!-- Блок с текстом и ссылкой -->
                                                        <h2 class="ISnqu">
                                                            <div>Вся эта дичь показана только тебе! Так шо никому не рассказывай чо тут увидел.
                                                                <a href="№" class="VZLjze">Панятна?!
                                                                </a>
                                                            </div>
                                                        </h2>
                                                    </div>
                                                    <!-- Блок с картинкой -->
                                                    <div class="CljqTd" style="width: 48px; height: 48px;">
                                                        <figure class="HJOYV HJOYVi24">
                                                            <img class="YPzqGd" src="/img/lc.png">
                                                        </figure>
                                                    </div>
                                                </header>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="ee-Ji-hc ee-Df-ie" style="height: 20px;">
                        ...
                        <div class="ee-Df-db">
                            <div role="button" class="a-b-c d-u d-u-R" tabindex="0" data-tooltip="Закрыть" aria-label="Закрыть" style="user-select: none;">
