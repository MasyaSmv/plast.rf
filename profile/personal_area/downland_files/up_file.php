                ...
                <div class="accordion" id="accordionExample">
                    <div class="card GnT3R">
                        <div class="card-header M3t4R" id="headingOne">
                            <h2 class="mb-0">
                                <button class="pHFe3 btn btn-link-free btn-block text-center" type="button"
                                                        ...
                                                        <div class="custom-file">
                                                            <form enctype="multipart/form-data" action="upload.php"
                                                                ...
                                                                <input name="userfile" type="file"
                                                                    class="custom-file-input" id="myInput"
                                                                    aria-describedby="myInput" />
                                                                <label class="custom-file-label" for="myInput">Загрузи
                                                                    файл сучечка</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-7">
                                                            <input type="text" class="form-control Uh3N5" name="city"
                                                                autocomplete="off" placeholder="City">
                                                        </div>
                                                        <div class="col">
                                                            <input type="text" class="form-control Uh3N5" name="country"
                                                                autocomplete="off" placeholder="Country">
                                                            <!-- Еще не добавлена в БД -->
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="VZLjze Wvetm I6g62c Of8KN kJXJmd">
                                                <div class="ng43Og mtfBU input-group-append">
                                                    <button class="btn btn-outline-secondary" type="submit"
                                                        ...
                                                        value="Отправить файл">Загрузить</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card GnT3R">
                        <div class="card-header M3t4R" id="headingTwo">
                            <h2 class="mb-0">
                                <button class="pHFe3 btn btn-link-free btn-block text-center collapsed" type="button"
                            ...
                            while ($pow = mysqli_fetch_array($result)) {?>
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
                                            <a
                                                href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>">Предыдущая
                                            </a>
                                        </li>
                                        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
                                            <a
                                                href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>">Следующая
                                            </a>
                                        </li>
                                    </ul>
