                                    ...
                                    <div
                                        ...
                                        <div class="Zlwi5e">
                                            <div class="Am5i9">
                                                <div class="zHA9i">
                                                    <div class="th336c">
                                                        <div class="O13N7c">Название компании</div>
                                                    </div>
                                                    <form method="POST" action="action.php" name="saveName">
                                                        <div class="input-group mb-3 wefgw card-body">
                                                        ...
                                                        <div class="zHA9i">
                                                            ...
                                                            <form method="POST" action="action.php" name="savePsevName">  <!-- Надо бы тоже сделать для нее скрипт-->
                                                        ...
                                                        <div class="ZCeVXe">
                                                            <div class="tnziZe tdgv8">
                                                                ...
                                                                <div class="UqOdF n48mwe"><span class="pvmCW"><span
                                                                    ...
                                                                    <div>Эту информацию смогут увидеть любые
                                                                        пользователи,
                                                                        которые будут общаться с
                                                                        вами или просматривать созданный вами
                                                                        контент в
                                                                        сервисах.
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="N1UXxf">
                                                <div class="form-group"><br />
                                                    <input class="btn btn-outline-primary" type="submit"
                                                        name="btn_save_name" value="Отправить">
                                                </div>
                                                </form>
                                            </div>
                                        </div>
