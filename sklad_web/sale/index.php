...
$title_tag="Кабель  и провод из наличия  - СКЛАД :: Распродажа :: ";
                    ...
                    <?php } else { ?>
                       ...
                       <?php } ?>
						...
						<?
								...
								echo "<a href='/catalog/$company_link' style='border: 2px solid #ff6600;margin-left: 5px;padding: 4px;'>Все позиции</a>&nbsp;&nbsp;&nbsp;";
								echo "<b style='border: 2px solid #ff6600;margin-left: 5px;padding: 4px;background:#ff6600;color:#fff;'>Распродажа</b>";
                        ...
                        <table>
                            ...
                            foreach($r as $rr){
                                ...
                                <tr>
                                    ...
                                    <td style="width: 125px;"><?php echo number_format(round($comments, 2), 2, ',', ' '); ?></td>
                                    <td><?php echo $city; ?></td>
                        ...
                        <div align="center">
                            <?php
                            if ($pages_count >1) { ?>
                                <?php echo show_links($page,$perpage,$count,"/sale/".$company[$comp_id]["sef"].$ruri."/",$dopurl); ?>
                            <?php } ?>
                        </div>
                    <?php } ?>
                </div>
